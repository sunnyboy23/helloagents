...
💡 使用方式:
  ...
  通用路径: 直接描述需求，系统自动路由至 R0~R2 级别
  外部工具: 调用 MCP/搜索等外部工具时自动识别

⚙️ 全局开关（~/.helloagents/helloagents.json 配置）:
  OUTPUT_LANGUAGE / KB_CREATE_MODE / BILINGUAL_COMMIT / EVAL_MODE / UPDATE_CHECK / CSV_BATCH_MAX / NOTIFY_LEVEL
